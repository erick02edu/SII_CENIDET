<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="inline-flex w-full pb-1" >
            ...
            <!--Seccion para cambiar campo de busqueda-->
            <div class="relative inline-block text-left pl-3">
                ...
                <div v-if="MostrarFiltro" class="origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-menu-button" tabindex="-1">
                    ...
                    <span @click="SeleccionarCampo('Codigo','Codigo')" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-slate-500 dark:text-gray-200">Código</span>
                    </div>
            ...
            <!--Boton para abrir modal para registrar una nueva materia-->
        ...
        <!--Modal para registrar una nueva materia-->
                                ...
                                <form @submit.prevent="crearMateria"  class="w-full max-w-lg">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input id="diagonal" v-model="NuevaMateria.Nombre"
                                            class="appearance-none block w-full bg-gray-200 dark:bg-slate-600 text-gray-700 dark:text-gray-200 border border-gray-200  dark:border-slate-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input id="diagonal" v-model="NuevaMateria.Codigo"  class="appearance-none block w-full bg-gray-200 dark:bg-slate-600 text-gray-700 dark:text-gray-200 border border-gray-200  dark:border-slate-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                        ...
                                        <div class="w-full md:w-full px-3">
                                            ...
                                            <input id="diagonal" v-model="NuevaMateria.Descripcion"
                                            class="appearance-none block w-full bg-gray-200 dark:bg-slate-600 text-gray-700 dark:text-gray-200 border border-gray-200  dark:border-slate-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                            type="text" placeholder="Agregue una descripcion" required>
                                        </div>
                                        <!-- Modal footer -->
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Esta seguro de eliminar esta materia </h3>
